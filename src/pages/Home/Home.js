...
import naruto from "./assets/logo.js";
...
export const Home = () => {
  ...
  const ShopItemFree = styled.div`
    ...
    &::after {
      ...
      background: ${(props) => props.theme.representativeColor};
      z-index: -1;
      background-size: 300%;
      border-radius: 10px;
    }
  ...
  const ShopItemPremium = styled.div``;
  ...
  return (
    <Container>
      ...
      <ShopHome>
        <ShopItemFree>
          <ListOfBenefits>
            ...
            <ListItems>
              ...
              <Item>
                <X size={20} color="#ed1212" weight="bold" />
                <p>Ad Free</p>
              </Item>
            </ListItems>
            <ListButtonGroup>
              <li className="home__cash-month">
                <i> </i>
              </li>
        ...
        <ShopItemPremium>
          <div className="home__img-shop">
            <img src={naruto} alt="" />
            <h1>
              <label className="premium-plan">Premium</label> Plan
            </h1>
          </div>
          ...
          <div className="home__button-shop">
            <li className="home__cash-month">
